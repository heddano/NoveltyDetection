...
public class Porterstemmer {
    ...
    // Some points of difference and common errors are described in
    ...
    /**
     * Adds a character to the word being stemmed. When all the characters are
     * added, you can call stem(void) to stem the word.
     *
     * @param character
     ...
     * a char[] array. This is like repeated calls of add(char character), but
     * faster.
     */
     ...
     *         stemming process. You also need to consult getResultLength() to
    ...
    /**
     * Measures the number of consonant sequences between 0 and j. if c is a
    ...
    /**
     * cvc(i) is true if, and only if, i-2,i-1,i has the form consonant - vowel
     * - consonant and also if the second c is not w, x or y. This is used when
     * trying to restore an e at the end of a short word. e.g. cav(e), lov(e),
    ...
    /**
     * r(s) replaces the portion of an array of char by the input string s.
     */
    ...
    /**
     * step1() gets rid of plurals and -ed or -ing. e.g.<br/>
     * <br/>
     * caresses -> caress<br/>
     * ponies -> poni<br/>
     * ties -> ti<br/>
